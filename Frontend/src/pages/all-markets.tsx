...
import { AddMarketModal } from "../components/features/markets/add-market-modal";
import { ContainerWithPadding } from "../components/shared/container";
import { Header } from "../components/widgets/header";
import { MarketsTable } from "../components/widgets/markets/markets-table";
import { useMessage } from "../hooks/use-message";
import { MessageReceiver } from "../shared/types";

export const AllMarketsPage: FC = () => {
    ...
    <>
      ...
      <ContainerWithPadding>
        <Flex justify="between" align="center">
          ...
          <AddMarketModal callback={messageReceiver}>
        ...
        <MarketsTable messageReceiver={messageReceiver} />
      </ContainerWithPadding>
    </>
  );
};
